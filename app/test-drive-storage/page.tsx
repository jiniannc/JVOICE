...
import { ArrowLeft, Upload, Download, Trash2, CheckCircle, XCircle, AlertTriangle } from "lucide-react"
...
export default function TestDriveStoragePage() {
  ...
  const handleLoadTest = async () => {
    ...
    try {
      const response = await fetch("/api/evaluations/load?limit=10")
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Google Drive 저장소 테스트</h1>
            <p className="text-gray-600">평가 결과의 Google Drive 저장 및 로드 기능을 테스트합니다.</p>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button 
                ...
                className="w-full"
              >
                {isLoading ? "저장 중..." : "Google Drive에 저장"}
              </Button>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Button 
                ...
                className="w-full"
              >
                {isLoading ? "로드 중..." : "Google Drive에서 로드"}
              </Button>
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <ul className="space-y-1 text-gray-600">
                  <li>• GOOGLE_SERVICE_ACCOUNT_KEY_PATH (필수)</li>
                  <li>• NEXT_PUBLIC_EVALUATIONS_FOLDER_ID (선택)</li>
                  <li>• Google Drive API 활성화</li>
                </ul>
                <p className="text-xs text-gray-500 mt-2">
                  폴더 ID 미설정 시 개인 드라이브 루트에 저장됩니다.
                </p>
              </div>
              <div>
                <h4 className="font-medium mb-2">API 엔드포인트</h4>
                <ul className="space-y-1 text-gray-600">
                  <li>• POST /api/evaluations/save</li>
                  <li>• GET /api/evaluations/load</li>
                </ul>
              </div>
            </div>
          </CardContent>
